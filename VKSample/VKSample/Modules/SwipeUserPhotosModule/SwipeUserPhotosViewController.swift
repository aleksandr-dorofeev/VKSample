...
final class SwipeUserPhotosViewController: UIViewController {
    ...
    private var photoGalleryNames: [String] = []
    ...
    func configurePhotosUserVC(photoGalleryNames: [String], currentPhotoIndex: Int) {
        self.photoGalleryNames = photoGalleryNames
    ...
    private func prepareAnimationForRightSwipe() {
        ...
        setImage(userPhotoURLText: photoGalleryNames[currentPhotoIndex], imageView: currentImageView)
        ...
        setImage(userPhotoURLText: photoGalleryNames[currentPhotoIndex - 1], imageView: nextImageView)
        currentPhotoIndex -= 1
    }
    ...
    @objc private func swipeGestureRecognizerAction(gesture: UISwipeGestureRecognizer) {
        ...
        case .right:
            guard
                currentPhotoIndex < photoGalleryNames.count,
                currentPhotoIndex > 0
            else { return }
            let viewWidth = view.frame.width
            makeSwipeAnimation(
        ...
        case .left:
            guard
                currentPhotoIndex < photoGalleryNames.count - 1,
                currentPhotoIndex >= 0
            else { return }
            makeSwipeAnimation(
                orientation: .left,
